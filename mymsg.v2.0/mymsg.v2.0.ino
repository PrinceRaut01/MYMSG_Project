...
const unsigned long scrollInterval = 150; // pixels scroll every 150ms
...
void drawMessages() {
  ...
  int y = -scrollY + lineHeight; // start offset for smooth scroll
...
void loop() {
  ...
  delay(50); // faster refresh for smooth scrolling
}
